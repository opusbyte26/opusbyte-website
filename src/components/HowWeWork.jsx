    ...
    <section className="py-24 bg-[#F8F9F3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-12 left-12 right-12 h-1 bg-[#E1E5D3] -z-0">
            <div className="h-full bg-[#BDC033] w-3/4"></div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 rounded-xl bg-[#EEF2C9] text-[#3F481A] border border-[#BDC033]/50 flex items-center justify-center font-bold text-lg">
                      <IconComp className="w-6 h-6 text-[#65721F]" />
                    </div>

                    <span className="text-2xl font-black text-[#E1E5D3]">
                      {step.num}
                    </span>
                  </div>
                  ...
                  {/* Status Indicator */}
                  <div className="pt-4 border-t border-[#E1E5D3]/60 flex items-center gap-2 text-xs font-semibold text-[#65721F]">
                    <Check className="w-4 h-4 text-[#BDC033]" />
